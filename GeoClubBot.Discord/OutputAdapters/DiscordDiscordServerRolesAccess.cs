...
public partial class DiscordDiscordServerRolesAccess(
    DiscordSocketClient client,
    ILogger<DiscordDiscordServerRolesAccess> logger,
    IOptions<DiscordConfiguration> config) : IDiscordServerRolesAccess
{
