...
public class HandleUserUpdatedForMemberRoleUseCase(
    ...
    ILogger<HandleUserUpdatedForMemberRoleUseCase> logger) : INotificationHandler<UserUpdatedEvent>
{
    public async Task Handle(UserUpdatedEvent notification, CancellationToken cancellationToken)
    {
        ...
        {
            logger.LogError(e, "Error while handling HandleUserUpdatedForMemberRoleUseCase");
        }
    }
}