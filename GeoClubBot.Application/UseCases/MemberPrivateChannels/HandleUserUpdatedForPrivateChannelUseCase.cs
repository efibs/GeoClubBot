    ...
    : INotificationHandler<UserUpdatedEvent>
{
    public async Task Handle(UserUpdatedEvent notification, CancellationToken cancellationToken)
    {
        ...
        {
            logger.LogError(e, "Error while handling HandleUserUpdatedForPrivateChannelUseCase");
        }
    }
    ...
    [LoggerMessage(LogLevel.Information,
        "Handling user updated for creating private text channel for club member '{clubMemberNickname}'...")]
    static partial void LogCreatingPrivateChannel(ILogger<HandleUserUpdatedForPrivateChannelUseCase> logger,
        string clubMemberNickname);

    [LoggerMessage(LogLevel.Information,
        "Handling user updated for deleting private text channel for club member '{clubMemberNickname}'...")]
    static partial void LogDeletingPrivateChannel(ILogger<HandleUserUpdatedForPrivateChannelUseCase> logger,
        string clubMemberNickname);
}