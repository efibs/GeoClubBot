...
namespace Infrastructure.OutputAdapters.Rendering;

public class SkiaSharpHistoryRenderer : IHistoryRenderer
{
    ...
    private static void DrawGrid(SKCanvas canvas, int padding, int width, double yMin, double yMax,
    ...
    private static void DrawBars(SKCanvas canvas, List<int> values, List<DateTimeOffset> timestamps,
    ...
    private static void DrawAxes(SKCanvas canvas, int padding, int width, int height, int bottomPadding)
    {
    ...
    private static void DrawLabels(SKCanvas canvas, int width, int height)
    {
        using var textPaint = new SKPaint();
        textPaint.Color = SKColors.Black;
        textPaint.IsAntialias = true;
    ...
    private static MemoryStream EncodeToPng(SKBitmap bitmap)
    {
